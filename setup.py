...
version_file = 'Pose_Estimate/version.py'
...
def get_hash():
    if os.path.exists('.git'):
        ...
        try:
            from Pose_Estimate.version import __version__
...
def get_ext_modules():
    ...
    if platform.system() != 'Windows' or force_compile:
        ext_modules = [
            ...
            make_cuda_ext(
                name='roi_align_cuda',
                module='Pose_Estimate.utils.roi_align',
                sources=['src/roi_align_cuda.cpp', 'src/roi_align_kernel.cu']),
            make_cuda_ext(
                name='deform_conv_cuda',
                module='Pose_Estimate.models.layers.dcn',
                sources=[
...
if __name__ == '__main__':
    ...
    setup(
        name='Pose_Estimate',
        version=get_version(),
        description='Code for Pose_Estimate',
        long_description=readme(),
        keywords='computer vision, human pose estimation',
        url='https://github.com/MVIG-SJTU/Pose_Estimate',
