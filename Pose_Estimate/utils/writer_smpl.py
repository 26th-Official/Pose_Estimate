...
from Pose_Estimate.utils.pPose_nms import pose_nms, write_json
    ...
    def update(self):
        ...
        while True:
            ...
            if boxes is None or len(boxes) == 0:
                ...
                if self.opt.save_img or self.save_video or self.opt.vis:
                    from Pose_Estimate.utils.vis import vis_frame_smpl
                    img = vis_frame_smpl(orig_img, result, smpl_output, self.opt, self.vis_thres)
                    if self.opt.show_skeleton:
                        from Pose_Estimate.utils.vis import vis_frame_skeleton
